...
bot = Bot("hqmpzihkcnpkqqipiowxjnffvvlyondk")
target = "g0B5mh105a0297c093014377e01f4216"
				...
				if msg["type"]=="Text" and not msg.get("message_id") in answered:
					if not sleeped:
						if hasAds(msg.get("text")) and not msg.get("author_object_guid") in admins :
							...
							try:
								rules = open("commands.txt","r",encoding='utf-8').read()
								bot.sendMessage(target, str(rules), message_id=msg.get("message_id"))
							except:
								print("err dastorat")
								
						elif msg.get("text") == "بکل":
							try:
								rules = open("kal.py","r",encoding='utf-8').read()
								bot.sendMessage(target, str(rules), message_id=msg.get("message_id"))
							except:
								print("err dastorat")								
						...
						elif msg.get("text") == "نوع بده" and msg.get("author_object_guid") :			

												bot.sendMessage(target, "کل لرز چهار خط دو محو ق افی کیب ازاد بجز اتو و خشاب حسگر فعال سر سیک", message_id=msg.get("message_id"))
												
						elif msg.get("text") == "حله" and msg.get("author_object_guid") :			

												bot.sendMessage(target, "اص میکنم", message_id=msg.get("message_id"))
												
						elif msg.get("text") == "اص میکنم" and msg.get("author_object_guid") :			

												bot.sendMessage(target, "1", message_id=msg.get("message_id"))												
						elif msg.get("text") == "1" and msg.get("author_object_guid") :			
												bot.sendMessage(target, "2", message_id=msg.get("message_id"))
												
						elif msg.get("text") == "2" and msg.get("author_object_guid") :			

												bot.sendMessage(target, "3", message_id=msg.get("message_id"))
												
						elif msg.get("text") == "3" and msg.get("author_object_guid") :			

												bot.sendMessage(target, "بکل‌موفق", message_id=msg.get("message_id"))
																			
																	
						elif msg.get("text") == "بکل‌موفق" and msg.get("author_object_guid") :			

												bot.sendMessage(target, "چس سکس مست چس سگ سکس سگ سکس مسس سگ سکس مست چس سگ سکس مست چس سگ سکس مست چس سگ سکس مست چس سگ سکس مست چس سگ سکس مست چس سگ سکس مست چس سگ سکس", message_id=msg.get("message_id"))
												
						elif msg.get("text") == "چس سکس مست چس سگ سکس سگ سکس مسس سگ سکس مست چس سگ سکس مست چس سگ سکس مست چس سگ سکس مست چس سگ سکس مست چس سگ سکس مست چس سگ سکس مست چس سگ سکس" and msg.get("author_object_guid") :			

												bot.sendMessage(target, "سکس مست سگ مست سگ مست نسل ول شل سکس مست سگ سکس مست سگ سکس مست سکس مست نسل سگ سکس مست سگ سگ مست سگ کس مست سکس مست سگ سکس مست سگ سکس مست سگ سکس مست سگ سکس مست سگ سکس مست نسل", message_id=msg.get("message_id"))
							...
							try:
								bot.sendMessage(target, "حتما باید بدونی؟", message_id=msg.get("message_id"))
							except:
								print("err answer hay")
								
						elif msg.get("text").startswith("چه خبر") or msg.get("text").startswith("چخبر"):
							try:
								bot.sendMessage(target, "خبر زیاده ولی خبرکش نیستم", message_id=msg.get("message_id"))
							except:
								print("err CheKhabar")
							...
							try:
								bot.sendMessage(target, "یکی هم مثل تو همش میخندید مُرد", message_id=msg.get("message_id"))
							except:
								print("err luagh")
							...
							try:
								...
								bot.sendMessage(target, "مشگلی پیش اومد دوباره تلاش کنید", message_id=msg["message_id"])
							except:
								bot.sendMessage(target, "پیوی واست ارسال کردم💝", message_id=msg["message_id"])
						
						elif msg.get("text").startswith("جوک") or msg.get("text").startswith("فان") or msg.get("text").startswith("طنز"):
							try:
						...
						elif msg.get("text").startswith("بیو") or msg.get("text").startswith("bio") or msg.get("text").startswith("بیوگرافی"):
							try:
						...
						elif msg["text"].startswith("اب هوا"):
							try:
					...
					if data["type"]=="RemoveGroupMembers":
						...
						try:
							user = bot.getUserInfo(data['performer_object']['object_guid'])["data"]["user"]["first_name"]
							bot.sendMessage(target, f"هــای {user} عزیز 😘🌹 \n • به گـروه {name} خیـلی خوش اومدی 😍❤️ \nلطفا قوانین رو رعایت کن .\n 💎 برای مشاهده قوانین کافیه کلمه (قوانین) رو ارسال کنی!\nدوست داری ربات بسازی؟ بیا اینجا😍👇 @TOCREATE ", message_id=msg["message_id"])
							# bot.deleteMessages(target, [msg["message_id"]])
						except:
